    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className={`fixed inset-y-0 left-0 w-64 bg-white shadow-lg transform transition-transform duration-300 ease-in-out z-50 lg:translate-x-0 ${
        ...
        <div className="flex items-center justify-between h-16 px-6 border-b border-gray-200">
          <h1 className="text-xl font-bold text-gray-800">Bad & Boujee Admin</h1>
          <button
            onClick={() => setSidebarOpen(false)}
        ...
        <nav className="mt-5 px-2">
          ...
          <div className="mt-8 pt-4 border-t border-gray-200">
            <button
              ...
              className="group flex items-center w-full px-2 py-2 text-sm font-medium rounded-md text-red-600 hover:text-red-900 hover:bg-red-50 transition-colors"
            >
